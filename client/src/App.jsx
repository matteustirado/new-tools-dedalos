...
// Imports dos clones de Aniversário (V2)
// Certifique-se de criar estes arquivos nas pastas correspondentes ou mude o caminho aqui.
import JukeboxV2 from './pages/anniversary/JukeboxV2';
import PricesDisplayV2 from './pages/anniversary/PricesDisplayV2';
import ScoreboardDisplayV2 from './pages/anniversary/ScoreboardDisplayV2';
import ScoreboardGameV2 from './pages/anniversary/ScoreboardGameV2';
    ...
    <BrowserRouter>
      <ConnectionGuardian>
        ...
        <Routes>
          ...
          {/* ROTA V2 - Jukebox Aniversário */}
          <Route path="/radio/jukebox/:unidade/v2" element={<JukeboxV2 />} />
          ...
          {/* ROTA V2 - Scoreboard Aniversário */}
          <Route path="/tools/scoreboard/display/:unidade/v2" element={<ScoreboardDisplayV2 />} />
          
          <Route path="/tools/scoreboard/game/:unidade" element={<ScoreboardGame />} />
          {/* ROTA V2 - Scoreboard Game Aniversário */}
          <Route path="/tools/scoreboard/game/:unidade/v2" element={<ScoreboardGameV2 />} />
          ...
          {/* ROTA V2 - Tabela de Preços Aniversário */}
          <Route path="/tools/prices/display/:unidade/v2" element={<PricesDisplayV2 />} />
