...
const HeaderIcons = () => (
    <div className="flex gap-1 mb-0.5 opacity-90">
        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#FFCC00" strokeWidth="3"><path d="M12 4L21 20H3L12 4Z" /></svg>
        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#FFCC00" strokeWidth="3"><circle cx="12" cy="12" r="9" /></svg>
        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#FFCC00" strokeWidth="3"><path d="M5 5L19 19M5 19L19 5" /></svg>
        <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#FFCC00" strokeWidth="3"><rect x="4" y="4" width="16" height="16" /></svg>
    </div>
);
                ...
                <div className="flex items-center h-full">
                    ...
                    >
                        {logoUrl ? (
                            ...
                            <div className="w-10 h-10"><LogoTriangle /></div>
                        )}
                    </div>
                </div>
