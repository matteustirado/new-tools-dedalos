...
export default function Home({ unit = 'sp' }) {
  ...
  const radioTools = [
    ...
    { id: 'jukebox', name: 'Jukebox', icon: 'queue_music', path: `/radio/jukebox/${unit}` },
  ...
  const peopleTools = [
    ...
    { id: 'gym-ranking', name: "Banana's Gym", icon: 'fitness_center', path: '/people/gym-ranking' }
  ];
  ...
  const forceGlobalReload = () => {
    const isConfirmed = window.confirm(
      'ATENÇÃO: Deseja forçar a atualização (Reload) de TODOS os tablets e telas espalhadas pela casa?'
    );
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="liquid-glass rounded-xl p-6">
            ...
            >
              ...
              <span
                className={`material-symbols-outlined text-white text-3xl transition-transform ${
                  expandedSections.radio ? 'rotate-180' : ''
                }`}
              >
                expand_more
              </span>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-text-muted text-sm">
                    Ferramentas de manutenção para{' '}
                    <span className={`uppercase ${unitTextColor} font-bold`}>{unitLabel}</span>
                  </p>
                </div>
              </div>
              <span
          ...
          <div className="liquid-glass rounded-xl p-6">
            ...
            >
              ...
              <span
                className={`material-symbols-outlined text-white text-3xl transition-transform ${
                  expandedSections.cx ? 'rotate-180' : ''
                }`}
              >
                expand_more
              </span>
