                ...
                <div className="flex flex-col gap-3">
                  <div className="flex justify-between items-center">
                    ...
                    <div onClick={() => setFormData(p => ({...p, isPermanent: !p.isPermanent}))} className="flex items-center gap-2 cursor-pointer group">
                       <span className={`text-[10px] font-black uppercase tracking-widest transition-colors ${formData.isPermanent ? 'text-red-500' : 'text-white/20 group-hover:text-white/40'}`}>Permanente</span>
