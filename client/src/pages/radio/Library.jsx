            ...
            <div className="flex gap-4 items-center">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full bg-white/10 border border-white/20 rounded-lg pl-12 pr-4 py-2 text-white placeholder:text-text-muted focus:ring-2 focus:ring-primary focus:border-transparent"
                />
              </div>
