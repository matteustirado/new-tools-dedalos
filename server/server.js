...
import peopleRoutes from './src/routes/peopleRoutes.js' // [NOVO] Rotas de RH
...
const uploadsPublicDir = path.join(__dirname, 'public/uploads') // [NOVO] Pasta para fotos de funcionários
...
const storage = multer.diskStorage({
    destination: (req, file, cb) => {
        if (file.fieldname === 'scoreboardImage') {
            ...
            // [NOVO] Redireciona fotos do RH para a pasta pública
...
app.use('/uploads', express.static(path.join(__dirname, 'public/uploads'))) // [NOVO] Permite acessar http://.../uploads/foto.jpg
...
app.use('/api/people', peopleRoutes) // [NOVO] Endpoint /api/people/...

// --- ROTAS DE UPLOAD ESPECÍFICAS (LEGADO/FERRAMENTAS) ---
...
// Inicializa o "Maestro" (Controle da Rádio)
iniciarMaestro()
